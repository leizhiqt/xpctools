...
public class DebugXslFo {
	...
	public DebugXslFo(String xmlFile, String xslFile, String varPath) {
		...
		try {
			...
			// BufferedReader XmlIn = new BufferedReader( new InputStreamReader(
			// System.in ) );
	...
	public void convertXML2PDF(File xml, File xslt, File pdf) throws TransformerException, IOException {
